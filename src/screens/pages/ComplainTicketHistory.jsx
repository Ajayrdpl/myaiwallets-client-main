...
const ComplainTicketHistory = () => {
    ...
    return (
      <div className="action-buttons">
        <Button
          ...
          style={{ color: "#00f", fontWeight: "600", marginRight: "10px" }}
        />
      </div>
    );
  };
  ...
  return (
    <>
      ...
      <div className="WithdrawalReport cardBox martop">
        <div className="dataTable ss-card martop">
          ...
          >
            ...
            <Column field="query" header="Message" filter sortable />
